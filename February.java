...
//Creates a February class with reference point of 2015 and increments months and dates by current year
public class February extends JPanel {
	
	private int year;	
	private String username,password;
	
	//requires current year, username, and password 
	public February(int year, String username, String password){
		...
		int extrayears=0;
		//every year months shift one day, every year after a leap year february shifts an extra day
		//adds extra days for adding up all the days incremented from reference year 2015 to current year
		//every leap year february also has an extra day
		...
		if(currentYear%4==0){
			for(int j=fixdays,k=1; k<=leapNum; j++,k++)
			{
